...
module.exports = __webpack_require__("F6qz");
...
const CheckInPage = () => {
  ...
  const proceed = () => {
    ...
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/become-a-host/advance");
    }, 500);
  };

  const revert = () => {
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/become-a-host/review-how-guests-book");
    }, 500);
  };
...
/* harmony default export */ __webpack_exports__["default"] = (CheckInPage);
