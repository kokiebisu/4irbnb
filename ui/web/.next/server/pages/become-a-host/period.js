...
module.exports = __webpack_require__("Yo06");
...
const PeriodPage = () => {
  ...
  const proceed = () => {
    ...
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/become-a-host/price");
    }, 500);
  };

  const revert = () => {
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/advance");
    }, 500);
  };
...
/* harmony default export */ __webpack_exports__["default"] = (PeriodPage);
