...
module.exports = __webpack_require__("5g0W");
...
/* harmony import */ var _context_stay__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("pl4W");
...
const PricePage = () => {
  const stayDispatch = Object(_context_stay__WEBPACK_IMPORTED_MODULE_4__[/* useStayDispatch */ "b"])();
  const {
    basePrice,
    currency
  } = Object(_context_stay__WEBPACK_IMPORTED_MODULE_4__[/* useStayState */ "c"])();
  const {
    0: data,
    1: setData
  ...
  const proceed = () => {
    ...
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/become-a-host/booking-scenarios");
    }, 500);
  };

  const revert = () => {
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/period");
    }, 500);
  };
...
/* harmony default export */ __webpack_exports__["default"] = (PricePage);
