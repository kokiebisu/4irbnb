...
module.exports = __webpack_require__("GdJX");
...
const BedRoomsPage = () => {
  ...
  const proceed = () => {
    ...
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/become-a-host/amenities");
    }, 500);
  };

  const revert = () => {
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/become-a-host/bathrooms");
    }, 500);
  };
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])(_layout__WEBPACK_IMPORTED_MODULE_3__[/* Layout */ "a"], {
    ...
    next: proceed,
    back: revert,
    criteria: data.street === "" || data.city === "" || data.state === "" || data.postal === ""
  });
};

/* harmony default export */ __webpack_exports__["default"] = (BedRoomsPage);
