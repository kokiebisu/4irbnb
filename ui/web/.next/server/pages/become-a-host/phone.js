...
module.exports = __webpack_require__("lEow");
...
const TitlePage = () => {
  ...
  const proceed = () => {
    ...
    setTimeout(() => {
      next_router__WEBPACK_IMPORTED_MODULE_2___default.a.push("/become-a-host/requirements");
    }, 500);
  };
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])(_layout__WEBPACK_IMPORTED_MODULE_3__[/* Layout */ "a"], {
    ...
    next: proceed,
    back: revert,
    criteria: data.phone === 0 // criteria={...verify the number}
