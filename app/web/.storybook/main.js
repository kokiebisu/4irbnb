...
module.exports = {
  ...
  webpackFinal: async (config) => {
    ...
    config.resolve.alias = {
      ...
      '@bullet': path.join(__dirname, '../components/atoms/bullet'),
      '@button': path.join(__dirname, '../components/atoms/button'),
      '@input': path.join(__dirname, '../components/atoms/input'),
      '@video': path.join(__dirname, '../components/atoms/video'),
