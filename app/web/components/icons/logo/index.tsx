...
export const NameLogo = (props: BaseIconProps): JSX.Element => {
  return (
    <svg {...props}>
...
export const NoNameLogo = ({ fill, ...props }: BaseIconProps): JSX.Element => {
  return (
...
export const FacebookLogoIcon = (props: BaseIconProps): JSX.Element => {
  return (
    <svg
...
export const GoogleLogoIcon = (props: BaseIconProps): JSX.Element => {
  return (
...
export const AppleLogoIcon = (props: BaseIconProps): JSX.Element => {
  return (
