...
export const NameLogo: React.FC<BaseIconProps> = (props) => {
  return (
    <svg {...props}>
...
export const NoNameLogo: React.FC<BaseIconProps> = ({ fill, ...props }) => {
  return (
...
export const FacebookLogoIcon: React.FC<BaseIconProps> = (props) => {
  return (
    <svg
...
export const GoogleLogoIcon: React.FC<BaseIconProps> = (props) => {
  return (
...
export const AppleLogoIcon: React.FC<BaseIconProps> = (props) => {
  return (
