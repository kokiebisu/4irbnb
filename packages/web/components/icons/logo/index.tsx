...
export const LogoIcon: React.FC<IconPropsWithType & LogoIconTypeProps> = ({
  logoType,
  ...props
}) => {
  const types = {
...
export const MenuBarLogo: React.FC<IconProps> = (props) => {
  return (
    <svg
      stroke="#737373"
      strokeWidth="1.5"
...
export const NameLogo: React.FC<IconProps> = (props) => {
  return (
    <svg {...props}>
...
export const NoNameLogo: React.FC<IconProps> = ({ fill, ...props }) => {
  return (
...
export const FacebookLogoIcon: React.FC<IconProps> = (props) => {
  return (
    <svg
...
export const GoogleLogoIcon: React.FC<IconProps> = (props) => {
  return (
...
export const AppleLogoIcon: React.FC<IconProps> = (props) => {
  return (
