...
export const AmenityIcon: React.FC<IconProps & AmenityIconTypeProps> = ({
  ...
  const types = {
    smokeAlarm: <SmokeAlarmIcon {...props} />,
    tv: <TVIcon {...props} />,
    kitchen: <KitchenIcon {...props} />,
    heating: <HeatingIcon {...props} />,
    privateEntrance: <PrivateEntranceIcon {...props} />,
    carbonAlarm: <CarbonMonoxideAlarmIcon {...props} />,
  };
  return types[amenityType];
};

export const SmokeAlarmIcon = (props) => {
  return (
...
export const PrivateEntranceIcon = (props) => {
  return (
    <svg {...props} viewBox="0 0 32 32">
...
export const CarbonMonoxideAlarmIcon = (props) => {
  return (
    <svg {...props} viewBox="0 0 32 32">
